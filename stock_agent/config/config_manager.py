...
class ConfigManager:
    ...
    def _init_mongodb_storage(self):
        ...
        try:
            ...
            database_name = os.getenv("MONGODB_DATABASE_NAME", "stock_agent")
    ...
    def _init_default_configs(self):
        ...
        if not self.settings_file.exists():
            # 导入默认数据目录配置
            import os
            default_data_dir = os.path.join(os.path.expanduser("~"), "Documents", "StockAgent", "data")
            ...
            default_settings = {
                ...
                "results_dir": os.path.join(os.path.expanduser("~"), "Documents", "StockAgent", "results"),  # 结果目录
    ...
    def load_settings(self) -> Dict[str, Any]:
        ...
        env_settings = {
            ...
            "results_dir": os.getenv("STOCK_AGENT_RESULTS_DIR", ""),
            "log_level": os.getenv("STOCK_AGENT_LOG_LEVEL", "INFO"),
            "data_dir": os.getenv("STOCK_AGENT_DATA_DIR", ""),  # 数据目录环境变量
            "cache_dir": os.getenv("STOCK_AGENT_CACHE_DIR", ""),  # 缓存目录环境变量
        }
    ...
    def get_env_config_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "other_configs": {
                ...
                "results_dir": os.getenv("STOCK_AGENT_RESULTS_DIR", "./results"),
                "log_level": os.getenv("STOCK_AGENT_LOG_LEVEL", "INFO"),
            }
        }
    ...
    def get_data_dir(self) -> str:
        ...
        if not data_dir:
            # 如果没有配置，使用默认路径
            data_dir = os.path.join(os.path.expanduser("~"), "Documents", "StockAgent", "data")
        return data_dir
