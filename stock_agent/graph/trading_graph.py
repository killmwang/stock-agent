# Stock Agent graph/trading_graph.py
...
from stock_agent.dataflows.interface import set_config
...
class StockAgentGraph:
    """Main class that orchestrates the Stock Agent analysis graph."""
    ...
    def __init__(
        ...
        """Initialize the analysis graph and components.
    ...
    def propagate(self, company_name, trade_date):
        """Run the analysis graph for a company on a specific date."""
    ...
    def _log_state(self, trade_date, final_state):
        ...
        # Save to file
        directory = Path(f"eval_results/{self.ticker}/StockAgentStrategy_logs/")
        directory.mkdir(parents=True, exist_ok=True)

        with open(
            f"eval_results/{self.ticker}/StockAgentStrategy_logs/full_states_log_{trade_date}.json",
            "w",
        ) as f:
