...
from stock_agent.agents.consolidation import create_consolidation_analyst
from stock_agent.agents.consolidation.consolidation_analyst import is_china_stock
...
class GraphSetup:
    ...
    def setup_graph(
        ...
        if len(selected_analysts) == 0:
            raise ValueError("Stock Agent graph setup error: no analysts selected!")
